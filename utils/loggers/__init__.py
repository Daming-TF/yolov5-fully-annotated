...
try:
    ...
    assert hasattr(wandb, '__version__')  # verify package import not local dir 验证导入包是不是本地目录
...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        # W&B 通过省实验跟踪，数据集版本控制和模型管理从而帮助开发者构建更好的模型
        ...
        # ClearML 一个用于记录代码运行过程，帮助开发者重现实验，自动化超参数优化并可视化结果的工具
